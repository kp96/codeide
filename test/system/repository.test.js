    ...
    describe('package.json', function () {
        ...
        describe('package.json JSON data', function () {
            it('must have valid name, description and author', function () {
                expect(json).to.have.property('name', 'codeide');
                expect(json).to.have.property('description', 'The online leetcode style ide for codeforces');
                expect(json).to.have.property('author', 'Krishna Kalubandi <krishnakalubandi@gmail.com>');
                expect(json).to.have.property('license', 'MIT');
                expect(json).to.have.property('homepage', 'https://github.com/kp96/codeide');
                expect(json).to.have.property('bugs', 'https://github.com/kp96/codeide/issues');

                expect(json).to.have.property('repository');
                expect(json.repository).to.eql({
                    type: 'git',
                    url: 'git://github.com/kp96/codeide.git'
                });

                expect(json).to.have.property('keywords');
                expect(json.keywords).to.eql(['codeforces', 'api', 'helper', 'onlineide']);
